...
<script type="text/javascript" src="${baseURL}/resource/js/addcpbystock.js"></script>
...
<hr>
	<div class="inputTag">
		<div><span>条码:</span>
			<input type="text" id="barCode" onkeyup="if (event.keyCode == 13) barCodePressEnter(); else barCodeChange();" />
