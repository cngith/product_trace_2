...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<script type="text/javascript" src="${baseURL}/resource/js/product_attribute/add_material.js"></script>
</head>
<body>
	...
	<hr>
		...
		<button onclick="validateClick()">验证</button> <span id="spanMaterialInfo"></span>
		</div>
		<div>
