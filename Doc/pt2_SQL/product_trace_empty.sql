...
-- Windows下导入脚本命令 source E:/Program/source/pt2/product_trace_empty.sql;
-- 开发期数据库
...
-- 正在导出表  product_trace_x.employee 的数据：~0 rows (大约)
...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `ShowNo` varchar(4) DEFAULT NULL COMMENT '展号',
  `barCode` varchar(12) NOT NULL COMMENT '条码',
  ...
  `ImagePath` varchar(800) DEFAULT NULL COMMENT '商品图片路径',
  PRIMARY KEY (`pdId`),
...
--SELECT "添加默认管理员账号adm";
INSERT INTO `user` (`userid`, `username`, `password`) VALUES	('', 'adm', '');
